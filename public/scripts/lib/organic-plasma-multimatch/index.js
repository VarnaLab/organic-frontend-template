...
define(['lib/dict', './roiterator', './arrayRemove', './map'], function (dict, Iterator, arrayRemove, MyMap) {
    
  //to be used with Plasma.use and Plasma.decorate
  return function (state) { //this is bound to new plasma object
  ...
  function invokeHandler(pmo, handler) {
    var args = [pmo.value];
